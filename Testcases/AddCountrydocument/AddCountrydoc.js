describe('Add country child section', function () {
  var EC = protractor.ExpectedConditions;
  var randNumber = browser.params.user.random;

  it('Add new country child section under the country document', function () {
    browser.sleep(3000);
    browser.executeScript('window.scrollTo(0,4000);').then(function () {
      browser.sleep(2000);
      var country = element(by.xpath('//article[@class="framework-grid-content CountrySection"]//a//*[@id="Layer_1"]'));
      country.click();
    })
    browser.sleep(2000);
